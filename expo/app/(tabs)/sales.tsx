...
function DailySalesScreenContent() {
  ...
  const renderTodaySaleItem = ({ item }: { item: {wine: Wine, sale: Sale} }) => (
    <View style={styles.saleItem}>
      ...
      <View style={styles.saleItemRight}>
        <Text style={styles.saleItemQuantity}>{item.sale.quantity} {item.sale.quantity === 1 ? 'bottle' : 'bottles'}</Text>
      </View>
    </View>
  );
            ...
            {showWineDropdown && (
              <View style={styles.dropdownContainer}>
                ...
                <FlatList
                  ...
                  ListEmptyComponent={
                    <Text style={styles.emptyListText}>No wines found</Text>
                  }
                />
              </View>
            )}
