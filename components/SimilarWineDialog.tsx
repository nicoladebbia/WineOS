          ...
          <ScrollView style={styles.scrollView}>
            ...
            <View style={styles.comparisonContainer}>
              <View style={styles.wineDetails}>
                <Text style={styles.detailsTitle}>Vino esistente:</Text>
              ...
              <View style={styles.wineDetails}>
                <Text style={styles.detailsTitle}>Nuovo vino:</Text>
            ...
            <Text style={styles.confirmText}>
              Sei sicuro di voler aggiungere {newWineName} {newWineYear}?
            </Text>
          </ScrollView>
