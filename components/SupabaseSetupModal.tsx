  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      if (success) {
        ...
        setError('Error setting up Supabase');
      }
    } catch (error) {
      ...
      <View style={styles.modalOverlay}>
        <View style={styles.modalContent}>
          ...
          <Text style={styles.description}>
            Enter your Supabase credentials to enable cloud sync across devices.
          </Text>
          ...
          >
            {isLoading ? (
              ...
              <>
                ...
                <Text style={styles.submitButtonText}>Configure Supabase</Text>
              </>
            )}
          </TouchableOpacity>
          
          <Text style={styles.helpText}>
            You can find this information in your Supabase project dashboard under "Settings" &gt; "API".
          </Text>
        </View>
      </View>
    </Modal>
