...
export default function RestockModal({ visible, wine, onClose }: RestockModalProps) {
  const [quantity, setQuantity] = useState(wine && wine.quantityTarget ? 
  ...
  const handleSubmit = () => {
    ...
    const newQuantity = wine.quantity + parseInt(quantity, 10);
    updateWine(wine.id, { 
  ...
  return (
    <>
            ...
            <View style={styles.wineInfo}>
              ...
              {wine.quantityTarget > wine.quantity && (
                <Text style={styles.targetQuantity}>
                  {translations.wine.quantityTarget}: {wine.quantityTarget} {wine.quantityTarget === 1 ? 'bottiglia' : 'bottiglie'}
                </Text>
              )}
            </View>
            
            <View style={styles.formGroup}>
              <Text style={styles.label}>{translations.actions.restock}</Text>
              <TextInput
      ...
      <Toast
        message={translations.notifications.restockSuccess}
        type="success"
        visible={showToast}
